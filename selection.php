        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#">
               <?php
$logoPath = "ejs_logo.png"; // Replace with the dynamic path to your logo image
$altText = "Company Logo"; // Replace with dynamic alternative text
?>

<!-- HTML code with inline CSS to set the height -->
<img src="<?php echo $logoPath; ?>" alt="<?php echo $altText; ?>" style="height: 20px;">

 
                <font size="3">Judging Management System</font></a>
